...
#endif
enum{
	PANEL_COUNT_X=PANEL_COUNT_WIDTH
	};
...
#endif
enum{
	PANEL_COUNT_Y=PANEL_COUNT_HEIGHT
	};
...
#endif
enum{
	ROWS_IN_PARALLEL=MATRIX_ROWS_IN_PARALLEL
	};
...
#endif
enum{
	ICN2053_DMA_ROW_BUFF_CNT=DMA_ROW_BUFF_CNT
	};
